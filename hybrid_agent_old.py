...
class HybridLiteratureAgent:
    ...
    def generate_review(
        ...
        if 'enhanced' in base_prompt:  # Crude check; or pass a flag from _build_enhanced_prompt
    ...
    def _build_enhanced_prompt(self, query: str, papers: List[Paper]) -> str:
        ...
        enhanced = base + "\n\nENHANCED STRUCTURE (MANDATORY):\n" \
            ...
            # f"USER PREFERENCES (from patterns): {self.pattern_memory.to_prompt_instructions()}\n\n" \
